...
@CrossOrigin(origins = "https://hr-management-f.vercel.app", allowCredentials = "true") // Allows requests from the
                                                                                        // specified origin with
                                                                                        // credentials
public class WeeklyActivityController {
    ...
    /**
     * Endpoint to get all weekly activities in the system, with optional search and
     * filter.
    ...
    public ResponseEntity<WeeklyActivity> updateWeeklyActivity(@PathVariable Long id,
            @RequestBody WeeklyActivity weeklyActivityDetails) {
        try {
